...
twoChainsReorderImprovesAdoExample08 :: Dist.T Rational (Int, Int, Int, Int, Int, Int, Int, Int)
twoChainsReorderImprovesAdoExample08 = CD.do
  a1 <- Dist.uniform [1, 2]
...
main :: IO ()
main = print (Dist.norm twoChainsReorderImprovesAdoExample08)
