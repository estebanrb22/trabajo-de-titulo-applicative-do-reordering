...
superGraphNoReorderExample06 :: Dist.T Rational (Int, Int, Int, Int, Int, Int)
superGraphNoReorderExample06 = CD.do
  ...
  x6 <- Dist.uniform [x1 + x2 + x3 + x4 + x5 + 100000, x1 + x2 + x3 + x4 + x5 + 200000]
  CD.return (x1, x2, x3, x4, x5, x6)

main :: IO ()
main = print (Dist.norm superGraphNoReorderExample06)
