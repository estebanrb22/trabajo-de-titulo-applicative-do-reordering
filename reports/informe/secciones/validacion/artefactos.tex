...
La validación deja artefactos reproducibles para inspeccionar el comportamiento del compilador y respaldar los resultados. Los experimentos viven bajo \texttt{experiments/}, mientras que los resultados se guardan bajo \texttt{tests/}. Los dos corpus siguen una estructura paralela por mónada, familia, caso y variante. El ejemplo guía usa las rutas directas \path{experiments/main-example} y \path{tests/main-example}.
...
\texttt{graph.log} & Presenta el grafo RAW en forma legible. \\
