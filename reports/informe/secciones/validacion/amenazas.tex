...
En primer lugar, los dos corpus evaluados son sintéticos. Esto permite controlar formas de dependencia, patrones de binders, comportamiento probabilístico y casos de costo, pero limita la validez externa de los resultados: la frecuencia de las oportunidades de reordenamiento y la escalabilidad del espacio de búsqueda podrían ser distintas en programas de mayor tamaño o no diseñados para aislar estos fenómenos.
