...
La primera limitación es semántica: \textsf{GHC} no prueba que una mónada sea conmutativa. El mecanismo implementado se basa en una declaración explícita del programador mediante \texttt{CD.do}. Si esa declaración es incorrecta, el compilador puede aceptar reordenamientos válidos respecto de las dependencias locales que cambien efectos observables, como ilustra el control con \texttt{IO}.
